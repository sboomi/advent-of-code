import pytest
from src.day11 import find_neighbors, update_octo_grid, count_flashes, find_synchro_step
...
def test_find_synchro_step():
    ...
    exp_step = 195
    act_step = find_synchro_step(energy_lvs)

    assert exp_step == act_step, f"Expected {exp_step} steps. Got {act_step} steps"
